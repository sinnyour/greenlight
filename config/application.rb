...
module Greenlight
  class Application < Rails::Application
    ...
    config.branding_image_default = "https://i.imgur.com/7FzLDRK.png"

    # Default primary color if the user does not specify one
    config.primary_color_default = "#0756F2"

    # Default primary color lighten if the user does not specify one
    config.primary_color_lighten_default = "#05F2DB"

    # Default primary color darken if the user does not specify one
    config.primary_color_darken_default = "#F20505"
